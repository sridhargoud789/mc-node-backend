              ...
              <tbody>
                <tr style="border-radius: 16px">
                  <td  style="border-radius: 16px;">
                    ...
                    <p
                      style="font-family: 'Montserrat'; font-style: normal; font-weight: 500; font-size: 14px; line-height: 24px; color: #212529; margin: 0; padding-bottom: 8px;">
                      Complete los ejercicios y cuestionarios recomendados.
                    </p>
                    <p
                      style="font-family: 'Montserrat'; font-style: normal; font-weight: 500; font-size: 14px; line-height: 24px; color: #212529; margin: 0; padding-bottom: 8px;">
                      Comuníquese con el instructor o los compañeros de aprendizaje si tiene alguna pregunta o necesita ayuda.
                    </p>
                    <p
                      style="font-family: 'Montserrat'; font-style: normal; font-weight: 500; font-size: 14px; line-height: 24px; color: #212529; margin: 0; padding-bottom: 8px;">
                      ¡Manténgase motivado y celebre sus logros en el camino!
                    </p>
                    <br/>
                    <br/>
