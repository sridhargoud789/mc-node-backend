                ...
                <tr style="border-radius: 16px">
                  <td  style="border-radius: 16px;">
                    ...
                    <p
                      ...
                      Han pasado algunos días desde que comenzaste tu viaje de aprendizaje en el curso ${course_name}. Esperamos que encuentre valioso el contenido del curso. Aquí hay un recordatorio rápido para mantener el impulso:
                    ...
                    <li style="line-height: 30px;">
                      Tome descansos breves durante las sesiones de estudio más largas para descansar y recargar energías.
                      </li>
                      <li style="line-height: 30px;">
                      Reflexione sobre lo que ha aprendido hasta ahora y cómo se aplica a los escenarios del mundo real.
                      </li>
                      <li style="line-height: 30px;">
                      Interactuar con la comunidad del curso a través de foros o foros de discusión.
                      </li>
                      <li style="line-height: 30px;">
                      Explore recursos adicionales o temas relacionados para profundizar su comprensión.
                      </li>
                   </ul>
                   <br/>
                   <br/>
