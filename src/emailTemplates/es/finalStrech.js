                ...
                <tr style="border-radius: 16px">
                  <td  style="border-radius: 16px;">
                    ...
                    <p
                      ...
                      Estás en la recta final de tu viaje de aprendizaje en el curso ${course_name}. Sigan con el excelente trabajo! Aquí hay algunos recordatorios para ayudarlo a aprovechar al máximo el tiempo restante:
                    </p>
                   ...
                   Revise los conceptos clave y revise cualquier tema desafiante.
                      </li>
                      <li style="line-height: 30px;">
                      Completa cualquier asignación o proyecto restante.
                      </li>
                      <li style="line-height: 30px;">
                      Prepare una lista de preguntas o temas para discutir durante las sesiones de preguntas y respuestas o en vivo del curso.
                      </li>
                      <li style="line-height: 30px;">
                      Planifica cómo aplicarás lo que has aprendido después de completar el curso.
                      </li>
                   </ul>
                  
                  <p
                  style="font-family: 'Montserrat'; font-style: normal; font-weight: 500; font-size: 14px; line-height: 24px; color: #212529; margin: 0; padding-bottom: 8px;">
                  Creemos en su capacidad para tener éxito en el curso ${course_name} y estamos aquí para apoyarlo a lo largo de su viaje de aprendizaje. Si tiene alguna pregunta, necesita ayuda o desea compartir su progreso, no dude en comunicarse con nuestro equipo de soporte.
