                ...
                <tr style="border-radius: 16px">
                  <td  style="border-radius: 16px;">
                    ...
                    <p
                      ...
                      You're in the final stretch of your learning journey in the course ${course_name}. Keep up the excellent work! Here are some reminders to help you make the most of the remaining time:

                    </p>
                    <p
                    style="font-family: 'Montserrat'; font-style: normal; font-weight: 500; font-size: 14px; line-height: 14px; color: #212529; margin: 0; padding-bottom: 8px;">
                   <ul>
                      <li>Revise key concepts and review any challenging topics.

                      </li>
                      <li>Complete any remaining assignments or projects.
                      </li>
                      <li>Prepare a list of questions or topics to discuss during the course's Q&A or live sessions.
                      </li>
                      <li>Plan how you'll apply what you've learned after completing the course.
                      </li>
                   </ul>
                  </p>
                  <p
                  style="font-family: 'Montserrat'; font-style: normal; font-weight: 500; font-size: 14px; line-height: 24px; color: #212529; margin: 0; padding-bottom: 8px;">
                  We believe in your ability to succeed in the course ${course_name} and are here to support you throughout your learning journey. If you have any questions, need assistance, or want to share your progress, feel free to reach out to our support team.
