                ...
                <tr style="border-radius: 16px">
                  <td  style="border-radius: 16px;">
                    ...
                    <p
                      ...
                      we're excited that you've set your first alarm for your learning tim9e in the course ${course_name}. It's time to prepare yourself for an enriching learning experience. Here are a few tips to get started:
                    </p>
                    <p
                     ...
                     <ul>
                        <li>Set up a quiet and comfortable study area.
                        </li>
                        <li>Gather all the necessary course materials.</li>
                        <li>Clear your schedule to fully focus on your learning session.
                        </li>
                        <li>Keep a notebook handy to jot down important points or questions.
                        </li>
                     </ul>
                    </p>
