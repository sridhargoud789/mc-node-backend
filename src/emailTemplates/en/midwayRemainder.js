                ...
                <tr style="border-radius: 16px">
                  <td  style="border-radius: 16px;">
                    ...
                    <p
                      ...
                      It's been a few days since you started your learning journey in the course ${course_name}. We hope you're finding the course content valuable. Here's a quick reminder to keep up the momentum:
                   ...
                   <ul>
                      <li>Take short breaks during longer study sessions to rest and recharge.
                      </li>
                      <li>Reflect on what you've learned so far and how it applies to real-world scenarios.
                      </li>
                      <li>Engage with the course community through forums or discussion boards.
                      </li>
                      <li>Explore additional resources or related topics to deepen your understanding.
                      </li>
                   </ul>
                  </p>
